...
code --force --install-extension /tmp/vscode-tlaplus-1.6.0.vsix
code --force --install-extension /tmp/better-comments-2.0.5.vsix
code --force --install-extension /tmp/efanzh.vsix
code --force --install-extension /tmp/tintinweb.vsix
code --force --install-extension /tmp/pdf.vsix
